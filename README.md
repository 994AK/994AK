...
广州全栈 Web 开发人员，主要专注于前端开发。凭借在 HTML、CSS、JavaScript方面的深厚背景，我热衷于创建视觉网站。我在 Vue.js 和 React 等现代前端框架方面积累了经验，不断寻找机会扩展我的知识。
除了在前端开发方面的专业知识外，我还拥有使用 go、node 进行后端开发的坚实基础。这种全面的技能组合使我能够无缝集成前端和后端组件，确保最佳功能和性能。
